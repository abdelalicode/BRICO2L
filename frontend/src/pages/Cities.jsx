...
export default function Cities() {
  ...
  return (
    ...
    <div className="mt-12 mb-24">
      <h1 className="text-center mb-16 m-4 text-2xl">AVAILABLE CITIES</h1>
      <div className="flex flex-wrap gap-4 justify-center">
        {cities.data.map((city, key) => (
          <div
            key={city.id}
            className="relative grid h-[16rem] w-full max-w-[24rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700"
          >
